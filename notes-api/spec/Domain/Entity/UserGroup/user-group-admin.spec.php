...
//todo Figure out what the hell a usergroup is and what other methods you should put in the owner and admin group and if
//todo there needs to be an admin and an owner object that extends User. I AM SO FKIN CONFUSED
describe('Notes\Domain\Entity\UserGroup\Admin', function() {
    ...
    describe('->__construct("cs3620", "an array with user objects", true)', function() {
        it('should return a Admin object that is initialized with a name and 2 initial user objects and should be able to create new notes', function () {
            ...
            $actual = new Admin($groupName, $initialUsers, true); // create new Admin group with name cs3620 and add an array with 2 users as initial users
            ...
            expect($actual->canManageUsers())->to->be->true;
    ...
    describe('->removeUser()', function(){
        it('Should remove a user object from the group', function() {
            ...
            $actual = new Admin($groupName, $initialUsers); // create new Admin group with name cs3620 and add an array with 2 users as initial users
